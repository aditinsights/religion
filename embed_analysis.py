...
#     keyword_embeddings = [embedding for embedding in keyword_embeddings]
#     keyword_embeddings = np.array(keyword_embeddings, dtype=np.float32)

#     return doc_analysis, keyword, keyword_embeddings

# def embeddings_analysis(chunk_embeddings, documents, doc_analysis, keywords, keyword_embeddings):
#     chunk_embeddings = [embedding for embedding in chunk_embeddings]
#     chunk_embeddings = np.array(chunk_embeddings, dtype=np.float32)
...
#             page_content = [doc]
#         biased_chunks = doc_analysis.find_bias_faiss(page_content, chunk_embeddings, keywords, keyword_embeddings, threshold=0.25)
#         if biased_chunks:
